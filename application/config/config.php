...
|
*/
#$config['cache_path'] = '/www/wwwroot/bookmark.gezhong.vip/application/cache/';
$config['cache_path'] = dirname(__DIR__).'/cache/';
...
|
*/
$config['encryption_key'] = 'nilai1will2make3money4';
