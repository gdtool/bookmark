            ...
            <header class="marks-heading">
                <div class="marks-heading-wrapper">
                    <div class="marks-heading-bar">
                        <h2 class="default-message"><?php echo unmark_phrase('All Marks') ?></h2>
                        <?php $this->load->view('layouts/topbar/searchform.php'); ?>
                    </div>
                </div>
            </header>
                ...
                <div id="mark-<?php print $mark->mark_id; ?>" class="mark label-<?php print $mark->label_id; ?>">
                    ...
                    <div class="archive-target">
                        <?php if ($lookup_type == "archive") : ?>
                            <a title="<?php echo unmark_phrase('Unarchive Mark')?>" class="action mark-archive" data-action="mark_restore" href="#" data-id="<?php print $mark->mark_id; ?>">
                        ...
                        <?php else : ?>
                            <a title="<?php echo unmark_phrase('Archive Mark')?>" class="action mark-archive" data-action="mark_archive" href="#" data-id="<?php print $mark->mark_id; ?>">
                                <i>
                    ...
                    <div class="mark-actions">
                        <a title="<?php echo unmark_phrase('View Mark Info')?>" class="action mark-info" href="#" data-nofade="true" data-action="show_mark_info" data-mark="mark-data-<?php print $mark->mark_id; ?>">
                            <i>
