    ...
    <figure id="resetPasswordForm" class="resetWrapper hiddenform">
        <div class="loginInner">
            ...
            <form id="send_password_change" method="post" action="#" class="ajaxsbmt">
                ...
                <button class="login-submit" type="submit"><?php echo unmark_phrase('Update') ?></button>
            </form>
            <div class="response-message"></div>
            <h4><?php echo unmark_phrase('Your Secret Key') ?></h4>
            <textarea readonly="readonly" rows=3 id="user_token" data-id="18" style="width: 100%;overflow: auto;word-break: break-all;"><?php echo sprintf( ((isset($user)) ? $user['user_token'] : '') ); ?></textarea>
        </div>
