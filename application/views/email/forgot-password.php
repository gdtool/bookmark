...
<head>
	...
	<style type="text/css">
		@import url(https://cdn.jsdelivr.net/gh/gdtool/testing/assets/css/fonts.css);
		...
		@media only screen and (max-width: 640px) {
			...
			td[class="menu"]{text-align:center !important; padding: 0 !important; display: none !important;}
		...
		@media only screen and (max-width: 480px) {
			...
			table[class=devicewidthinner] {width: 308px!important;text-align:center!important;}
			table[class="sthide"]{display: none!important;}
		...
		<tr>
			<td width="100%">
				<table width="580" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
					...
					<!-- Spacing -->
					<tr>
						<td align="center" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 10px;color: #999999" st-content="preheader"></td>
					</tr>
					<!-- Spacing -->
					<tr>
						<td width="100%" height="10"></td>
...
<div class="block">
	...
	<table width="100%" bgcolor="#f6f4f5" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="header">
		...
		<tr>
			<td>
				<table width="580" bgcolor="#303030" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth" hlitebg="edit" shadow="edit">
					<tbody>
					<tr>
						<td>
							<!-- logo -->
							<table width="280" cellpadding="0" cellspacing="0" border="0" align="left" class="devicewidth">
								<tbody>
								<tr>
									<td valign="middle" width="270" style="padding: 10px 0 6px 12px;" class="logo">
										<div class="imgpop">
							...
							<table width="280" cellpadding="0" cellspacing="0" border="0" align="right" class="devicewidth">
								<tbody>
								<tr>
									<td width="270" valign="middle" style="font-family: 'Montserrat', Helvetica, Arial, sans-serif;font-size: 12px;text-transform: uppercase;letter-spacing:1px; color: #e7e7e7;line-height: 39px; padding: 10px 0;font-weight: normal;" align="right" class="menu" st-content="menu">
										<a href="http://help.unmark.it" style="text-decoration: none; color: #e7e7e7;padding: 0 20px;">Help</a>
									</td>
								</tr>
								</tbody>
							</table>
								...
								<tr>
									<td>
										<table height="36" align="center" valign="middle" border="0" cellpadding="0" cellspacing="0" class="tablet-button" st-button="edit">
											<tbody>
											<tr>
												<td width="auto" align="center" valign="middle" height="45" style=" background-color:#ffffff; background-clip: padding-box;font-family: 'Montserrat', Helvetica, Arial, sans-serif;font-size: 13px;text-transform: uppercase;letter-spacing:1px; text-align:center;  color:#333333; font-weight: 300; padding-left:30px; padding-right:30px; border: 2px solid #e4e4e4;">
													<span style="color: #333333; font-weight: 300; text-align:center">
														Reset Password
													</span>
												</td>
											</tr>
					...
					<tr>
						<td>
							<table width="540" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner">
								...
								<!-- content -->
								<tr>
									<td style="font-family: Helvetica, arial, sans-serif; font-size: 13px; color: #888888; text-align:center;line-height: 20px;padding: 0 30px;" st-content="fulltext-paragraph">
										Your password has been reset. <br />
										Please click the link below to login and specify a new one:
									</td>
								</tr>
								<!-- End of content -->
								<!-- Spacing -->
					...
					<tr>
						<td>
							<table width="540" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner">
								...
								<tr>
									<td style="font-family: Helvetica, arial, sans-serif; font-size: 13px; color: #888888; text-align:center;line-height: 20px;padding: 0 30px;" st-content="fulltext-paragraph">
										<a href="{URL}" style="color:#259bcf;word-break: break-all;">Click here to reset your password.</a>
									</td>
								</tr>
								<!-- End of content -->
								<!-- Spacing -->
